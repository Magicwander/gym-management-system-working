...
@section('page-title', 'Create New Workout Plan')
            ...
            <div class="card-body">
                <form action="{{ route('trainer.workouts.store') }}" method="POST" id="workoutForm">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('workout_date') is-invalid @enderror" id="workout_date" name="workout_date" value="{{ old('workout_date', date('Y-m-d')) }}" required>
                                @error('workout_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('duration') is-invalid @enderror" id="duration" name="duration" value="{{ old('duration', 60) }}" min="15" max="180" required>
                                @error('duration')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('price_lkr') is-invalid @enderror" id="price_lkr" name="price_lkr" value="{{ old('price_lkr') }}" min="0" step="0.01" max="999999.99" required>
                                </div>
                                @error('price_lkr')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('calories_target') is-invalid @enderror" id="calories_target" name="calories_target" value="{{ old('calories_target') }}" min="0">
                                ...
                                <div class="exercise-item border rounded p-3 mb-3">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" name="exercises[0][exercise_id]" required>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" class="form-control" name="exercises[0][sets]" min="1" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label">Reps <span class="text-danger">*</span></label>
                                            <input type="number" class="form-control" name="exercises[0][reps]" min="1" required>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label">Weight (kg)</label>
                                            <input type="number" class="form-control" name="exercises[0][weight]" min="0" step="0.5">
                                        </div>
                                        <div class="col-md-2">
                                            <label class="form-label">Rest (sec)</label>
                                            <input type="number" class="form-control" name="exercises[0][rest_time]" min="0">
                                        </div>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-md-10">
                                            <label class="form-label">Exercise Notes</label>
                                            <input type="text" class="form-control" name="exercises[0][notes]" placeholder="Special instructions...">
                                        </div>
                                        <div class="col-md-2 d-flex align-items-end">
                                            <button type="button" class="btn btn-danger btn-sm remove-exercise" style="display: none;">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        <a href="{{ route('trainer.workouts.index') }}" class="btn btn-secondary me-2">Cancel</a>
